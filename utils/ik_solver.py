...
# 하이퍼파라미터 / 상수
# ─────────────────────────────────────────
L1_DEFAULT = 0.28   # 상완 (m)
L2_DEFAULT = 0.22   # 전완 (m)
L3_DEFAULT = 0.08   # 손목~흡착기 (m)

BOARD_ORIGIN_X = 0.12    # 체스판 원점 오프셋 x (m)
BOARD_ORIGIN_Y = -0.112  # 체스판 원점 오프셋 y (m)
CELL_SIZE      = 0.028   # 한 칸 크기 (m)
PIECE_Z        = 0.015   # 기물 높이 (m)
LIFT_DEFAULT   = 0.10    # 안전 접근 높이 (m)
