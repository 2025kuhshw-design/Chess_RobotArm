...
if __name__ == "__main__":
    ...
    # 실측 관절 좌표 (단위: m)
    # 첫 관절: 원점에서 (32, 63, 6)mm = (0.032, 0.063, 0.006)m
    # 이후 관절은 Z축 방향으로 L1, L2, L3 누적
    joint_positions = [
        [0.032, 0.063, 0.006],                       # joint1 (베이스 서보 축)
        [0.032, 0.063, 0.006 + 0.140],               # joint2 (어깨) +140mm
        [0.032, 0.063, 0.006 + 0.140 + 0.155],       # joint3 (팔꿈치) +155mm
        [0.032, 0.063, 0.006 + 0.140 + 0.155 + 0.075],  # 끝단(흡착기) +75mm
    ]
